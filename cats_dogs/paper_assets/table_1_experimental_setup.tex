...
\midrule
Evaluation split & benchmarks/cats\_dogs/train.csv & Matches steering sweep eval set \\
...
\bottomrule
\end{tabular}
\caption{Cats/dogs experimental setup and design decisions.}
\label{tab:cats-dogs-setup}
\end{table}
