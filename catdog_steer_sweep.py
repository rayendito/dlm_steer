...
#### OUTPUTS
CSV_ROOT = Path("timpateks_results/catdog_steer_sweep_csv")
HTML_ROOT = Path("timpateks_results/catdog_steer_sweep_html")
...
def main():
    run_steer_vector_sweep(
        SteerVectorSweepConfig(
            dataset_name="catdog",
            target_directions=("cat", "dog"),
            classifier_choices=("cat", "dog"),
